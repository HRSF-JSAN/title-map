...
CREATE TABLE `Types` (
  `id` INTEGER NULL AUTO_INCREMENT DEFAULT NULL,
  `Pizza` VARCHAR NULL DEFAULT NULL,
  `American` VARCHAR(100) NULL DEFAULT NULL,
  `Chinese` VARCHAR NULL DEFAULT NULL,
  `Italian` VARCHAR NULL DEFAULT NULL,
  `Mexican` VARCHAR NULL DEFAULT NULL,
  `Indian` VARCHAR NULL DEFAULT NULL,
  `French` VARCHAR NULL DEFAULT NULL,
  `Brunch` VARCHAR NULL DEFAULT NULL,
  PRIMARY KEY (`id`)
);
